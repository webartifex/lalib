...
- non-release versions are only allowed with a .devN suffix
...
class TestPEP404Compliance:
    ...
    def parsed_version(self):
        ...
        return pkg_version.Version(lalib.__version__)  # noqa:WPS609
    ...
    def test_parsed_version_is_all_public(self, parsed_version):
        ...
        assert parsed_version.public == lalib.__version__  # noqa:WPS609
...
class TestSemanticVersioning:
    ...
    def test_version_is_semantic(self):
        ...
        result = self.version_pattern.fullmatch(lalib.__version__)  # noqa:WPS609
